        ...
        <div className="container" style={{ maxWidth: "800px" }}>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "32px", borderBottom: "1px solid rgba(0,107,255,0.15)", paddingBottom: "16px" }}>
              ...
              <h2 style={{ fontFamily: "var(--font-display)", fontSize: "1.4rem" }}>Cookie & Storage Disclosure</h2>
            </div>
            ...
            <h3 style={{ fontFamily: "var(--font-display)", fontSize: "1.1rem", marginTop: "32px", marginBottom: "16px" }}>1. What Are Cookies?</h3>
            <p style={{ marginBottom: "24px" }}>
            ...
            <h3 style={{ fontFamily: "var(--font-display)", fontSize: "1.1rem", marginTop: "32px", marginBottom: "16px" }}>2. Types of Cookies We Use</h3>
            <p style={{ marginBottom: "24px" }}>
            ...
            <h3 style={{ fontFamily: "var(--font-display)", fontSize: "1.1rem", marginTop: "32px", marginBottom: "16px" }}>3. Managing Preferences</h3>
            <p style={{ marginBottom: "24px" }}>
