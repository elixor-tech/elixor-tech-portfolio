        ...
        <div className="container" style={{ maxWidth: "800px" }}>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "32px", borderBottom: "1px solid rgba(0,107,255,0.15)", paddingBottom: "16px" }}>
              ...
              <h2 style={{ fontFamily: "var(--font-display)", fontSize: "1.4rem", color: "#fff" }}>Agreement to Terms</h2>
            </div>
            ...
            <h3 style={{ fontFamily: "var(--font-display)", fontSize: "1.1rem", color: "#fff", marginTop: "32px", marginBottom: "16px" }}>1. Intellectial Property</h3>
            <p style={{ marginBottom: "24px" }}>
            ...
            <h3 style={{ fontFamily: "var(--font-display)", fontSize: "1.1rem", color: "#fff", marginTop: "32px", marginBottom: "16px" }}>2. Use of Services</h3>
            <p style={{ marginBottom: "24px" }}>
            ...
            <h3 style={{ fontFamily: "var(--font-display)", fontSize: "1.1rem", color: "#fff", marginTop: "32px", marginBottom: "16px" }}>3. Project Agreements</h3>
            <p style={{ marginBottom: "24px" }}>
            ...
            <h3 style={{ fontFamily: "var(--font-display)", fontSize: "1.1rem", color: "#fff", marginTop: "32px", marginBottom: "16px" }}>4. Limitation of Liability</h3>
            <p style={{ marginBottom: "24px" }}>
